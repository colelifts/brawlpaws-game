...
- Chapter 6: Shadow Realm, with six production-painted moonless arenas; Shadowstep Ferret, Veilwing Owl, and Graveback Bear armies; animated shadow fog; predictive Eclipse Rifts; and a dedicated Throne Beyond the Moon guardian court.
...
Systems QA is available at `?system=levelup`, `?system=story&beat=interlude2`, `?system=story&beat=interlude4`, `?system=contracts`, `?system=contracts&ready=1`, `?system=event`, `?system=secret`, `?system=synergy`, `?system=elites`, `?system=specialists`, `?system=specialists&set=late`, `?system=capstone`, `?system=evolutions`, `?system=pressure`, `?system=room6`, `?system=signature`, and `?system=codex`.
