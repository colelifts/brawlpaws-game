...
- Guardian timing, damage identity, phase labels, and phase schedules now live in reusable BossPattern and BossProfile definitions consumed by all three current boss fights
- Guardian profiles now also own per-phase tempo and recurring arena-domain cadence: predictive Bellstorm targets, persistent Moonbloom slow zones, and alternating Oni-fire corridors create three mechanically distinct late-fight pressure tests
